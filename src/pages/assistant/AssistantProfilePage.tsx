...
const AssistantProfilePage: React.FC = () => {
  ...
  return (
    <div className="p-6 space-y-6 max-w-4xl mx-auto">
      {/* Header */}
      <div className="bg-gradient-to-r from-cyan-600 to-teal-700 rounded-2xl p-8 text-white shadow-xl">
        <div className="flex items-center gap-6">
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/60 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">
              <div className="flex gap-2">
                <button
                  ...
                  className="p-2 bg-cyan-500 hover:bg-cyan-600 rounded-full transition-colors disabled:opacity-50"
          ...
          <div>
            ...
            <p className="text-cyan-100">Gérez vos informations personnelles</p>
            {user.assignedTo && (
              <div className="flex items-center gap-2 mt-2 bg-white/20 rounded-lg px-3 py-1.5">
                <People size={16} color="white" variant="Bold" />
                <span className="text-sm">Assigné à: <span className="font-semibold">{user.assignedTo.username}</span></span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="p-6 space-y-4">
          {!isEditingUsername ? (
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              ...
              >
                <Edit2 size={20} color="#0891B2" variant="Bold" />
              </button>
            </div>
          ) : (
            <form onSubmit={handleUsernameChange} className="p-4 bg-cyan-50 rounded-lg border border-cyan-200">
              ...
              <input
                ...
                maxLength={30}
                pattern="^[a-zA-Z0-9_-]+$"
                className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
