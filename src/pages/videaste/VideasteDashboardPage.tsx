...
const VideasteDashboardPage: React.FC = () => {
  ...
  const quickActions = [
    {
      title: 'Mes Vidéos',
      description: 'Voir toutes les vidéos qui me sont assignées',
      icon: <Video color="#3B82F6" size={24} variant="Bold" />,
      color: 'blue',
      path: '/videaste/videos'
    },
    {
      title: 'Calendrier',
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100 text-lg">
              Gérez vos vidéos et suivez votre progression
            </p>
          </div>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Timer size={16} color="#3B82F6" variant="Bold" />
