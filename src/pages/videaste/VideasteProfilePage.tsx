                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="relative group">
                    {user.profileImage ? (
                      ...
                      <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center border-2 border-gray-200">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-sm font-medium ml-2 inline-flex items-center gap-1">
                        <VideoPlay size={14} color="#2563EB" />
                        <span className="text-blue-600">Vidéaste</span>
                      </span>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
