...
const AssistantDashboardLayout: React.FC = () => {
  ...
  const sidebarItems: SidebarItem[] = [
    {
      ...
      label: 'Dashboard',
      icon: <Home color="#06B6D4" size={20} />,
      description: 'Vue d\'ensemble',
    },
    {
      path: '/assistant/videos',
      label: 'Vidéos',
      icon: <VideoPlay color="#06B6D4" size={20} />,
  ...
  const isActivePath = (path: string) => {
    if (path === '/assistant/dashboard') {
      return location.pathname === '/assistant/dashboard' || location.pathname === '/assistant';
    }
        ...
        <div className="flex flex-col flex-grow bg-white border-r border-gray-200 shadow-sm">
          ...
          <div className="flex items-center gap-3 p-6 border-b border-gray-200">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Assistant Panel</p>
            </div>
          </div>

          {/* Assigned Videaste Info */}
          {user?.assignedTo && (
            <div className="px-4 py-3 bg-cyan-50 border-b border-cyan-100">
              <div className="flex items-center gap-2 text-sm">
                <People size={16} color="#06B6D4" />
                <span className="text-gray-600">Vidéaste:</span>
                <span className="font-medium text-cyan-700">{user.assignedTo.username}</span>
              </div>
            </div>
          )}
            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex-1 lg:flex-initial">
                <h2 className="text-lg font-semibold text-gray-900">
                  {(() => {
                    ...
                    return currentItem?.label || 'Dashboard Assistant';
                  })()}
                </h2>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  ...
                  >
                    <div className="w-8 h-8 bg-cyan-100 rounded-full flex items-center justify-center overflow-hidden">
                      {user?.profileImage ? (
                        <img
